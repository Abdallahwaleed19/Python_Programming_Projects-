...
class _BookDetailsScreenState extends State<BookDetailsScreen> {
  ...
  Future<void> _loadBookDetails() async {
    ...
    try {
      ...
      print('Book data from Firestore: ${bookDoc.data()}'); // Debug log
  ...
  Future<void> _purchaseBook() async {
    ...
    try {
      ...
      print('Book data before purchase: $_book'); // Debug log
      ...
      print('Purchase data saved for book: ${_book!['title']}'); // Debug log
      ...
      await FirebaseFirestore.instance
        ...
        'author': _book!['author'],
        'price': (_book!['price'] as num).toDouble(),
        'purchaseDate': purchaseDate.toIso8601String(),
